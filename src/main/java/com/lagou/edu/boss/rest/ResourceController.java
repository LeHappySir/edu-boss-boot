...
public class ResourceController {
    ...
    public Result<Boolean> saveOrUpdate(@RequestBody ResourceForm resourceForm) {
        ResourceDTO resourceDTO = CoverUtil.cover(resourceForm, ResourceDTO.class);
    ...
    public Result<Boolean> saveOrUpdateCategory(@RequestBody ResourceCategoryForm resourceCategoryForm) {
        ResourceCategoryDTO resourceCategoryDTO = CoverUtil.cover(resourceCategoryForm, ResourceCategoryDTO.class);
    ...
    public Result<Boolean> allocateRoleResources(@RequestBody AllocateRoleResourceForm allocateRoleResourceForm) {
        ...
        AllocateRoleResourceDTO allocateRoleMenuDTO = CoverUtil.cover(allocateRoleResourceForm, AllocateRoleResourceDTO.class);
