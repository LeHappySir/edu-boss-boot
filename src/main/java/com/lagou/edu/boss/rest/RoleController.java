...
import com.lagou.edu.authority.client.dto.UserRoleDTO;
...
public class RoleController {
    ...
    public Result<Boolean> saveOrUpdate(@RequestBody RoleForm roleForm) {
        RoleDTO roleDTO = CoverUtil.cover(roleForm, RoleDTO.class);
    ...
    public Result<Boolean> allocateUserRoles(@RequestBody AllocateUserRoleForm allocateUserRoleForm) {
        ...
        AllocateUserRoleDTO allocateUserRoleDTO = CoverUtil.cover(allocateUserRoleForm, AllocateUserRoleDTO.class);
